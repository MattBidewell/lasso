  ...
  return (
    ...
    >
      ...
      >
        ...
        <text> </text>
        <text fg={COLORS.accent}><strong>  Global</strong></text>
        ...
        <text fg={COLORS.accent}><strong>  Navigation</strong></text>
        ...
        <text fg={COLORS.accent}><strong>  Output Panel</strong></text>
        <text fg={COLORS.normal}>    x             Stop running session</text>
        <text fg={COLORS.normal}>    k             Stop running session</text>
        <text fg={COLORS.normal}>    Ctrl+C        Stop running session</text>
        <text fg={COLORS.muted}>  ─────────────────────────────────────────────</text>

        <text fg={COLORS.accent}><strong>  History Panel</strong></text>
